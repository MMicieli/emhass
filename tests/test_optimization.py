...
class TestOptimization(unittest.IsolatedAsyncioTestCase):
    ...
    def test_thermal_loss_timestep_invariant(self):
        ...
        Reference plant uses a 259 L water tank with standard water properties
        and direct-electric efficiency=1.0.
        ...
        for timestep_min, expected_delta_t in cases:
            with self.subTest(timestep_min=timestep_min):
                ...
                retrieve_hass_conf["optimization_time_step"] = pd.Timedelta(minutes=timestep_min)
